...
public class BalanceSheetReportActionBean extends BaseBean {
	...
	private List<BalanceSheetDTO> formatBS2Series(List<BalanceSheetDTO> dtoList) {
		...
		tCurrentLiabilitiesList.addAll(dtoList.subList(1, dtoList.indexOf(_02_006_000Object)));
		...
		tLeaseLiabilityList.addAll(dtoList.subList(dtoList.indexOf(_02_014_000Object), dtoList.size() - 1));
	...
	public boolean generateReport(List<BalanceSheetDTO> dtoList) {
		try {
			...
			if (criteria.isMonth()) {
				parameters.put("startDate", BusinessUtil.getBudgetStartDate());
				parameters.put("endDate", BusinessUtil.getBudgetEndDate());
	...
	public void exportExcel(List<BalanceSheetDTO> dtoList) {
		...
		try {
			...
			BalanceSheetReportExcel balanceSheetReportExcel = new BalanceSheetReportExcel();
			balanceSheetReportExcel.generate(op, dtoList, criteria);
